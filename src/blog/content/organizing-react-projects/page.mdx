...
Let's take a closer look at our components folder. In modern React projects,
it's very common to have a folder that contains prebuilt components from a
...
where code should belong. Does having some of the component files in `📁/ui`
